    ...
    <div id="header" class="without-secondary-menu">
      <div class="custombackground">
        <div class="section clearfix">
              <a href="/resources/Index.htm" title="Home" rel="home" id="logo">
        ...
        <div id="main-menu" class="navigation">
          ...
          <ul class="nice-menu nice-menu-down jquery-once-3-processed sf-js-enabled" id="nice-menu-0">
			...
			<li class="menu-3952 menu-path-kompasgramediahiringbosscom-candidateApplicationdosubdomain odd"><a id="tampil-frame" href="/career/vacancy/" title="" onclick="tampilframe()" >SUBMIT CV</a></li>
