...
<body>
    ...
    <form name="form_datapublikasi" id="form_datapublikasi" method="get" style="padding: 15px;">
        ...
        <div id="loadButtonPublication">
            <a data-toggle="modal" href="#dialog-publikasi" class="btn"><i class="icon-plus"></i> <?=lang('tambah')?></a>
            <br /><br />
        ...
        <div id="dialog-publikasi" class="modal custom hide fade in" style="display: none;">
            <div class="modal-header">
                ...
                <h4><?=lang('data_karya')?></h4>
            </div>
            <div class="modal-body">
                <div class="form-horizontal" style="margin-left: -40px;">              
                    <div class="control-group">
                        <label class="control-label" for="judul"><?=lang('judul')?> </label>
                        <div class="controls">
                            <textarea name="judul" id="judul" cols="40" rows="4"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="keterangan"><?=lang('keterangan')?> </label>
                        <div class="controls">
            ...
            <div class="modal-footer">
                ...
                <input type="submit" class="btn btn-info" name="simpan_publikasi" id="simpan_publikasi" value="<?=lang('simpan')?>" />
    ...
    <div id="dialog-delete-publication" class="modal custom hide fade in" style="display: none;">
        <div class="modal-header">
            <h4><?=lang('hapus')?> <?=lang('publikasi')?></h4>
        </div>
        <div class="modal-body" id="body-delete-publication">                
        </div>                                    
        <div class="modal-footer">
            <input type="hidden" name="hidden_del_publikasi" id="hidden_del_publikasi" />
            <input type="submit" class="btn btn-info" name="hapus_publikasi" id="hapus_publikasi" value="<?=lang('hapus')?>" />
            <a href="#" class="btn" data-dismiss="modal"><?=lang('batal')?></a>
        </div>
    </div>    
