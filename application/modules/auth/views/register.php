      ...
      <div class="row" style="z-index: 22;">
        ...
        <div class="span4 droppedFields activeDroppable" style="z-index: 23;margin-right: 90px;">
          ...
          <form id="form_register" name="form_register" method="post">
            ...
            <div class="control-group droppedField" style="z-index: 24;" id="CTRL-DIV-1003">
              <div class="controls">
                <input type="text" name="city" id="city" placeholder="<?= lang('kota') ?>" class="input-xlarge "/>
              </div>
            </div>
            ...
            <div class="control-group droppedField" style="z-index: 24;" id="CTRL-DIV-1003">
              <div class="controls">
                ...
                <div id="workSought_Group">
                  <input type="checkbox" name="workSought[]" value="permanent" class="checbox" id="workSought">Permanent</input>
                  <input type="checkbox" name="workSought[]" value="parttime" class="checbox" id="workSought">Part-time</input>
                  <input type="checkbox" name="workSought[]" value="contract" class="checbox" id="workSought">Contract/Temp</input>
                  <input type="checkbox" name="workSought[]" value="graduate" class="checbox" id="workSought">Graduate</input>
                  <input type="checkbox" name="workSought[]" value="intership" class="checbox" id="workSought">Internship</input>
                  <input type="checkbox" name="workSought[]" value="graduate_h_s" class="checbox" id="workSought">Graduate High School</input>
                </div>
                <label for="workSought" class="error"><?= lang('error_worksought') ?></label>
            ...
            if ($forgot == false) {
              ...
              <span id="logins">
                ...
                if ($this->session->userdata('errorMsg') != "active") {
                  ?>
                  <?php echo form_open("register",array('id' => 'login')); ?>
                  <legend class="legendwhite"><span style="padding: 0 5px;">Login</span></legend>
                  <div class="control-group droppedField" style="z-index: 31;" id="CTRL-DIV-1001">
                  ...
                  <div class="control-group droppedField" style="z-index: 32;" id="CTRL-DIV-1002">
