...
*/
$config['tables']['users']           = 'tbaAppUserList';
$config['tables']['groups']          = 'tbaAppLevelList';
$config['tables']['users_groups']    = 'tbaAppUserLevel';
$config['tables']['login_attempts']  = 'tbaAppLoginAttempts';
$config['tables']['pages']			 = 'tbaAppPageList';
$config['tables']['page_previlege']	 = 'tbaAppPagePrevilege';
$config['tables']['web_redirect']	 = 'tbaAppWebRedirect';
 ...
 */
$config['join']['users']  = 'AppUserLevelUserID';
$config['join']['groups'] = 'AppUserLevelLevelID';
...
$config['default_group']        = 'external_candidate'; 				// Default group, use name
$config['admin_group']          = 'administrator';		// Default administrators group, use name
$config['identity']             = 'AppUserListEmail'; 				// A database column which is used to login with
