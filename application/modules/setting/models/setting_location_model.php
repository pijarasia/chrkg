<?php
class Setting_Location_Model extends MY_Model
{
	/**
  ...
  protected $_temporary_with_deleted = FALSE;
	...
	public function add(array $data){
		if ($this->check($data[$this->_name])){
			$this->set_error('location_creation_duplicate_name');
			return FALSE;
		}
		$this->set_message('location_creation_successful');
	...
	public function change(array $data,$id = null){
		...
		if (count($result) == 0)
		{
			$this->set_error('location_change_unsuccessful');
			return FALSE;
		}
		...
		if ($return)
		{
			$this->set_message('location_change_successful');
		}
		else
		{
			$this->set_error('location_change_unsuccessful');
	...
	public function delete(){
		...
		if ($delete){
			$this->set_message('location_delete_successful');
      $this->_aj['status'] = 'success';
			$this->_aj['message'] = $this->messages;
		}else {
			$this->set_errpr('location_delete_successful');
