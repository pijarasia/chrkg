...
?>
var Document = {
  url: '<?php echo base_url()."setting/candidate_sources";?>',
  refresh: function() {
    this.loadData();
    return false;
  },
...
var deleteG = function(id){
  ...
  $.ajax({
      url : "<?php echo base_url(); ?>setting/candidate_sources_delete",
      type : 'POST',
      data : form_data,
      success: function(d){
        $.pnotify({
...
$(document).ready(function() {
  ...
  $("#save").click(function() {
    ...
    if(!$valid) {
      ...
      $.ajax({
        url: '<?php echo base_url()."setting/candidate_sources_form" ?>',
        type: 'POST',
        dataType: 'json',
