<div class='content-inner well'>
    <div class="row-fluid">
        <div class="span3">
        	<form class="form-inline" id="sform" method='post'>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="s_id" name='s_id' placeholder="ID" class="input-xlarge"/>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="s_refname" name='s_refname' placeholder="Ref Name" class="input-xlarge"/>
                    </div>
                </div>
                <div class="control-group">
        ...
        <div class="span9" style="text-align: right;">
            <a class="btn btn-small btn-primary" data-toggle="modal" data-target="#dialog" href="#dialog" id="add"><i class="icon-plus"></i> Add Group</a>
            <div class="btn-group">
    ...
    <table class="table table-bordered table-striped sortable">
        <thead>
            <tr>
                <th data-key='_id' data-sortkey='asc'>ID</th>
                <th data-key='_name' data-sortkey='asc'>Name</th>
                <th data-key='_refname' data-sortkey='asc'>RefName</th>
...
<?php echo modules::run('usermanagement/group_modal'); ?>