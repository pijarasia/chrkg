...
<div class='content-inner well'>  
    ...
    <table class="tblDalam">
        <tr>
            <td rowspan="7" class="atas" style="width: 140px;">
            ...
            <td>
                <table>
                    ...
                    <tr>
                        ...
                        <td class="atas">:</td>
                        <td><?php echo $details->joborderRequirements;?></td>
                    </tr>     
                </table>
            </td>
        </tr>
        ...
        <div id="dialog-apply-job" class="modal custom hide fade in" style="display: none;">
            <div class="modal-body" style="padding-left: 15px;" id="body-apply-job">                
                ...
                <div style="padding: 5px 0;">
                    <input type="file" title="<?php echo lang('unggah')." ".lang('cover_letter')?>" class="btn-small" id="fileCoverLetter" name="fileCoverLetter"/>
                    <div id="upload" style="color: #800000;padding-left: 2px;"></div>
                </div>
                <div style="padding: 5px 0;">
                    <input type="file" title="<?php echo lang('unggah')." ".lang('cv')?>" class="btn-small" id="fileCV" name="fileCV"/>
